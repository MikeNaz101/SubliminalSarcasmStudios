...
const allLandmarks: Landmark[] = [
    ...
    { name: "Hannaford", category: "Services", coords: { lat: 43.3281, lng: -73.6791 }, desc: "Located exactly 0.2 miles from your front door. 4 minute walk.", img: "/images/hannaford.jpg" },
    { name: "Anytime Fitness Gym", category: "Health", coords: { lat: 43.3285, lng: -73.6785 }, desc: "24/7 gym located in the same plaza as Hannaford.", img: "/images/anytime.jpg" },
    { name: "CVS / Pharmacy", category: "Services", coords: { lat: 43.3262, lng: -73.6782 }, desc: "Located 0.2 miles away for all prescription needs. 5 minute walk.", img: "/images/cvs.jpg" },
    { name: "Glens Falls High School", category: "Education", coords: { lat: 43.3155, lng: -73.6558 }, desc: "Within a mile of the community, offering academic and athletic excellence.", img: "/images/school.jpg" },
    { name: "Hudson River Credit Union", category: "Services", coords: { lat: 43.3245, lng: -73.6748 }, desc: "Closest bank is only 0.4 miles away (9 minute walk).", img: "/images/bank.jpg" },
    { name: "WellNow - Urgent Care", category: "Health", coords: { lat: 43.3275, lng: -73.6765 }, desc: "Only a 7 minute walk, ensuring emergencies are solvable quickly.", img: "/images/wellnow.jpg" },
    { name: "Cool Beans Cafe", category: "Dining", coords: { lat: 43.3258, lng: -73.6762 }, desc: "Best coffee in the region! THE BIG BLT is a must try.", img: "/images/cool-beans.jpg" },
    { name: "Jim's Liquor", category: "Services", coords: { lat: 43.3278, lng: -73.6788 }, desc: "Located across from Hannaford for all spirits and supplies.", img: "/images/jims.jpg" },
    { name: "Child Care Center", category: "Education", coords: { lat: 43.3290, lng: -73.6770 }, desc: "Multiple options like Building Kids within a 4-minute walk.", img: "/images/childcare.jpg" },
    { name: "Taco Bell", category: "Dining", coords: { lat: 43.3352, lng: -73.6855 }, desc: "Only 1.2 miles away! A 24 minute walk for taco needs.", img: "/images/tacobell.jpg" },
    { name: "McDonalds", category: "Dining", coords: { lat: 43.3348, lng: -73.6848 }, desc: "Right across from Taco Bell, offering quick options.", img: "/images/mcdonalds.jpg" },
    { name: "Exit 18 of the Northway", category: "Services", coords: { lat: 43.3075, lng: -73.6825 }, desc: "Located only 0.3 miles from the Northway for effortless commuting.", img: "/images/exit18.jpg" },
    ...
    { name: "Six Flags Great Escape", category: "Entertainment", coords: { lat: 43.3512, lng: -73.6895 }, desc: "Roller coasters and water park 2 exits north.", img: "/images/six-flags.jpg" },
    { name: "The Outlets", category: "Services", coords: { lat: 43.3555, lng: -73.6888 }, desc: "Top-brand shops for all attire needs. 7 exits away.", img: "/images/outlets.jpg" },
    { name: "Martha's Ice Cream", category: "Dining", coords: { lat: 43.3525, lng: -73.6898 }, desc: "Legendary ice-cream shop just across from Six Flags.", img: "/images/marthas.jpg" },
    ...
    { name: "Cole’s Woods", category: "Outdoors", coords: { lat: 43.3168, lng: -73.6515 }, desc: "Pioneering groomed ski trails and lush hiking paths.", img: "/images/coles-woods.jpg" },
    ...
    // --- INDOOR ADVENTURE ---
    { name: "Sky Zone Trampoline Park", category: "Entertainment", coords: { lat: 43.3005, lng: -73.6802 }, desc: "Wall-to-wall aerial action for high-energy family fun.", img: "/images/sky-zone.jpg" },
    { name: "The Fun Spot", category: "Entertainment", coords: { lat: 43.3402, lng: -73.6908 }, desc: "Indoor rock climbing, go-karts, laser tag, and skating.", img: "/images/fun-spot.jpg" },
];
...
export default function Landmarks({ limit }: { limit?: number }) {
    ...
    const calculateRoute = (dest: { lat: number, lng: number }) => {
        ...
        service.route(
            { origin: SJP_LOCATION, destination: dest, travelMode: google.maps.TravelMode.DRIVING },
            (result, status) => {
                if (status === "OK" && result) {
